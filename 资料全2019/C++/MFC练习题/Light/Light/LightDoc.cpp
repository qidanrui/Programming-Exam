...
// 缩略图的支持
void CLightDoc::OnDrawThumbnail(CDC& dc, LPRECT lprcBounds)
{
	// 修改此代码以绘制文档数据
...
// 搜索处理程序的支持
void CLightDoc::InitializeSearchContent()
{
...
void CLightDoc::SetSearchContent(const CString& value)
{
	if (value.IsEmpty())
	{
